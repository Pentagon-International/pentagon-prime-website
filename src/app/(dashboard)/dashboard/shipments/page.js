    ...
    <Box id="tab-shipments" className="tab-panel active">
      <Box className="dash">
        ...
        <Box className="kpi-grid4">
          ...
          <Box
            className="kpi"
            style={{ "--kc": "var(--blue-mid)", "--ki": "#EBF2FF" }}
          >
            <Box className="kpi-bar"></Box>
            <Box className="kpi-ico">🚢</Box>
        ...
        <Box
          className="card"
          style={{ padding: 0, overflow: "auto", marginBottom: "16px" }}
        >
          <Table className="tbl">
            <thead>
              <tr>
              ...
              {filtered.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ fontSize: "11px", minWidth:"80px" }}>{r.origin}</td>
                    <td style={{ fontSize: "11px", minWidth:"80px" }}>{r.dest}</td>
                    <td style={{ fontSize: "11px", minWidth:"120px" }}>{r.commodity}</td>
                    <td style={{ whiteSpace: "nowrap", fontSize: "11px" }}>
                      {r.mode}
                    </td>
                    <td style={{ fontSize: "11px", color: "var(--txt3)" }}>
                      {r.weight}
                    </td>
                    <td style={{ color: "var(--txt3)", fontSize: "11px", minWidth:"80px" }}>
                      {r.etd}
                    </td>
        ...
        <Box className="g2">
          <Box className="card">
            <Box className="card-head">
              ...
              <Text span className="bdg bdg-warn" miw={140}>
                Action Required
              </Text>
            </Box>
            <Box className="al-row">
              ...
              <Box className="al-body">
                <Box className="al-title">
                  BL-20240892 — Hamburg Congestion Delay
                </Box>
                <Box className="al-sub">
                  FCL 40' · New ETA Apr 14 (was Apr 12) · MSC Gulsun vessel
                </Box>
              </Box>
            ...
            <Box className="al-row">
              ...
              <Box className="al-body">
                <Box className="al-title">
                  BL-20240888 — Customs Documentation Required
                </Box>
                <Box className="al-sub">
                  New York CBP requesting Form 7512 · Please upload via
                  Documents tab
                </Box>
              </Box>
          ...
          <Box className="card">
            ...
            <Box className="al-row">
              ...
              <Box className="al-body">
                ...
                <Box className="al-sub">
                  Delivered Apr 07 · 3 days early · Auto parts · 18T
                </Box>
              </Box>
            ...
            <Box className="al-row">
              ...
              <Box className="al-body">
                ...
                <Box className="al-sub">
                  Delivered Apr 05 · On schedule · Flat steel · 24T
                </Box>
              </Box>
            ...
            <Box className="al-row">
              ...
              <Box className="al-body">
                ...
                <Box className="al-sub">
                  Delivered Apr 02 · 1 day early · Wire rods · 12T
                </Box>
              </Box>
      ...
      <Modal
        ...
        title={
          selected ? (
            <Box className="modal-title">{selected.bl} — Shipment Detail</Box>
          ) : null
        }
        centered
        ...
        {selected && (
          <>
            ...
            <Box className="modal-body">
              ...
              >
                ...
                <Box className="doc-row">
                  ...
                  <Box className="doc-info">
                    <Box className="doc-name">
                      Bill of Lading — {selected.bl}
                    </Box>
                    <Box className="doc-meta">
                      Auto-generated by PRIME AI · Validated
                    </Box>
                  </Box>
                ...
                <Box className="doc-row">
                  ...
                  <Box className="doc-info">
                    ...
                    <Box className="doc-meta">
                      HS {selected.hs} · Validated by PRIME
                    </Box>
                  </Box>
                  <Button className="dl-btn">↓ PDF</Button>
                </Box>
              ...
              {/* Actions */}
              <Box style={{ display: "flex", gap: "10px", marginTop: "28px" }}>
